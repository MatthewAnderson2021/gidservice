...
namespace GudelIdService.Migrations
{
    ...
    [Migration("20201016172936_PermissionKeyEntity")]
    partial class PermissionKeyEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GudelIdService.Domain.Models.PermissionKey", b =>
                {
                    b.Property<string>("GudelId_Id")
                        .HasColumnType("char(12)");
            ...
            modelBuilder.Entity("GudelIdService.Domain.Models.PermissionKey", b =>
                {
                    b.HasOne("GudelIdService.Domain.Models.GudelId", "GudelId")
                        .WithMany("PermissionKeys")
                        .HasForeignKey("GudelId_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
